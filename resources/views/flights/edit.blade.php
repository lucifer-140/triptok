...
<div class="container">
    ...
    <form action="{{ route('flights.update', [$day, $flight]) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="date" name="date" id="flight_date" class="form-control" value="{{ $flight->date }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="cost" id="cost" class="form-control" value="{{ $flight->cost }}" required>
        </div>
